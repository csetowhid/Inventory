        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-2">Insert New Supplier</h3>
                        <router-link class="btn btn-info btn-sm" to="/supplier" id="add_new">All Supplier</router-link></nav>
                    </div>
                    <div class="card-body">
