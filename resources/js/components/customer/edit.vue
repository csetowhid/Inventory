        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-2">Customer Update</h3>
                        <router-link class="btn btn-info btn-sm" to="/customer" id="add_new">Customer Update</router-link></nav>
                    </div>
                    <div class="card-body">
