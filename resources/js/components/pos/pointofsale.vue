        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-2">Point Of Sale</h3>
                        <!-- <router-link class="btn btn-info btn-sm" to="/store-product" id="add_new">Add Product</router-link> -->
...
<input type="text" placeholder="Search" v-model="searchTerm" class="form-control"><br>
...
<input type="text" v-model="getsearchTerm" class="form-control" placeholder="Search"><br>
 ...
 <span v-if="getproduct.product_quantity >=1" class="badge badge-success">Available ({{getproduct.product_quantity}})</span>
 					<span class="badge badge-danger" v-else="" disabled="" >Stock Out</span>
					  </div>
					</div>
					</button>
                  </div>
...
export default {
    ...
    methods:{
    	...
    	orderdone(){
            ...
            Toast.fire({
                      icon: 'success',
                      title: 'Successfully Order Added!'
                    })
