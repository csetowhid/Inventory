        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-2">Employee Salary Update</h3>
                            ...
                            <input type="hidden" v-model="form.employee_id">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><label class="small mb-1" for="inputConfirmPassword">Salary</label>
                                        <input class="form-control py-4" type="text" placeholder="Salary" v-model="form.amount" />
...
methods:{
    salaryUpdate(){
        ...
        .then(()=>{
            Toast.fire({
                      icon: 'success',
                      title: 'Successfully Salary Updated!'
                    })
